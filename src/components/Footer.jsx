          ...
          <div className="md:flex md:justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="text-blue-900 font-bold ps-5 text-[20px]">
                National Colorectal
                <span className="block -mt-2 text-[#ef1827]">Center</span>
              </span>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-gray-600  font-medium">
                  ...
                  <BsFacebook className="text-blue-700"/><a href="https://facebook.com" className="hover:underline ">
                   Facebook
                    </a>
                  </li>
                  <li className="mb-1 flex flex-row gap-2 items-center">
                    <BsInstagram className="text-red-700"/><a
                  ...
                  <li className="mb-1 flex flex-row gap-2 items-center">
                  <BsWhatsapp className="text-green-700"/>  <a href="https://whatsapp.com" className="hover:underline ">
                      WhatsApp
                    </a>
                  </li>
                  <li className="mb-1 flex flex-row gap-2 items-center">
                    <BsTwitter className="text-blue-900"/><a href="https://viber.com" className="hover:underline ">
                      Viber
                    </a>
                  </li>
                </ul>
