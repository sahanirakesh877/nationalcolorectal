...
<section className=" dark:bg-gray-900 bg-gray-200 overflow-hidden">
  <div className="container px-6 py-20 mx-auto">
    <div>
      <p className="font-bold text-3xl text-center text-blue-900 dark:text-blue-400">Contact us</p>
      <h1 className="mt-2 pt-6 text-xl font-semibold text-gray-800 md:text-3xl dark:text-white ">Chat to our friendly team</h1>
    ...
    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
        <div>
          <span className="inline-block p-3 text-white rounded-full bg-blue-900/80 dark:bg-gray-800">
          ...
          <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">sahanirakesh877@gmail.com</p>
        </div>
        <div>
          <span className="inline-block p-3 text-white rounded-full bg-blue-900/80 dark:bg-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Meet Your Dpoctors</p>
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Sun-Fri from 8am to 5pm.</p>
      ...
      <div className="p-4 py-6 rounded-lg bg-white dark:bg-gray-800 md:p-8">
        <form>
          ...
          <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-900 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
            Send message
          </button>
        </form>
      </div>
